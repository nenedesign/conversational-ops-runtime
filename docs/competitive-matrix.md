...
**Legend:** `✓` Confirmed from public docs or code · `~` Partial or inferred · `?` Not evaluated · `✗` Absent or not found
...
| **REST-first protocol (no SDK required to submit a tool call)** | ✓ | ? | ? | ? |
| **Policy gating** | ✓ | ✓ | ✓ | ✓ |
